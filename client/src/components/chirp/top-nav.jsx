...
export default function TopNavigation() {
  ...
  return (
    <header className="bg-background-primary sm:bg-transparent bg-white/90 border-b px-4 md:px-6 flex items-center justify-between h-14 shadow fixed top-0 right-0 left-0 z-12 backdrop-blur">
